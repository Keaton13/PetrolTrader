...
const styles = {
    ...
    header: "mt-5 md:mt-10 text-center text-4xl md:text-5xl font-extrabold p-1 pl-4 pr-2 text-2xl",
    headerBorderLeft: "mt-5 md:mt-10 text-center text-4xl md:text-5xl font-extrabold p-1 pl-4 pr-2 text-2xl border-l border-gray-400",
    ...
    detailsContainer: "mt-10 md:mt-16 flex flex-wrap sm:flex-nowrap justify-center",
  ...
  return (
    <div className={styles.container}>
      <div className="flex flex-col md:flex-row items-center justify-center">
        <h1 className={styles.header}>{data.year} {data.manufacturer} {data.model}</h1>
